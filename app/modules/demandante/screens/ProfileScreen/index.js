...
const ProfileScreen = (props) => {
  ...
  const medios = [
    {
      ...
      action: () => Alert.alert("yendo a whatsapp"),
    },
    {
      name: "SMS",
      Icon: images.icon_sms,
      action: () => Alert.alert("mandando sms"),
    },
    {
      name: "LLAMADA",
      Icon: images.icon_telefono,
      action: () => Alert.alert("llamaando a tu mama"),
    },
  ];
  ...
  return (
    <View style={styles.container}>
      <Image source={images.trabajadores_a} style={styles.portada} />
      <Text
        {...typography["title-28"]}
      ...
      <Image source={images.trabajadores_a} style={styles.photo} />
      <Text
        {...typography["body-16"]}
        color={colors.grey.t60}
        extraStyles={styles.description}
      >
        Me llamo Nahuel, tengo 28 años y vivo en la cuidad de La Plata. Vengo de
        una familia de plomeros, y con muchos años de practica. Me especializo
        en ....
      </Text>
      <View
        style={{
