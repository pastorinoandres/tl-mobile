    ...
    return(
      <LinearGradient style={styles.covid} {...colors.demandanteGradient}>
        ...
        <View style={{justifyContent:'space-between',flex:7}}>
          <Text {...typography["body-16"]} color={colors.white(1)}  extraStyles={{textAlign:'right'}}> Dada la situación actual algunos servicios se encuentran demorados.</Text>
          <Text {...typography["body-strong-16"]} color={colors.white(1)}  extraStyles={{textAlign:'right'}}> COVID-19</Text>
        </View> 
      </LinearGradient> 
    )
}
