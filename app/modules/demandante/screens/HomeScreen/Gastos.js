  ...
  return(
    <View style={styles.container}>
      <View style={styles.card}>
        <Text {...typography["title-20"]} color={colors.grey.t80} extraStyles={{textAlign:'left',marginBottom:30, width:'100%'}}>Gastos de Abril</Text> 
        <Text {...typography["body-16"]} color={colors.grey.t60} extraStyles={{textAlign:'left', marginBottom:30, width:'100%'}}>No se registran gastos en el mes corriente.</Text>      
      </View>
    </View>
  )
}
