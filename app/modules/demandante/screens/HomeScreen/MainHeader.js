  ...
  return(
    <>
      ...
      <Animated.View style={styles.title}>
          <Text {...typography["title-28"]} color={colors.demandantes.primary}  extraStyles={{textAlign:'left'}}> Hola Andres,</Text>
          <Text {...typography["body-20"]} color={colors.grey.t80} extraStyles={{textAlign:'left'}}> ¡Que tengas un excelente dia!</Text>               
      </Animated.View>
        ...
        <Animated.View style={styles.button}>
          <TouchableAnimated onPress={defaultCallToAction}>
            <Animated.View style={styles.buttonContain}>
              <Store color={colors.white(1)} extraStyles={{marginRight:ui.margin}}/>
              <Text {...typography["body-20"]} color={colors.white(1)}  extraStyles={{textAlign:'center'}}> Pedir un servicio</Text>
            </Animated.View>              
          </TouchableAnimated>
          <TouchableAnimated onPress={goInitial}>
            <Animated.View style={{...styles.header,transform:[{translateY}]}}>
              <Text {...typography["title-20"]} color={colors.white(1)}  extraStyles={{textAlign:'center',}}> Inicio</Text>
            </Animated.View>
          </TouchableAnimated> 
        </Animated.View>        
      </Animated.View>
      
      <HamburgerMenu style={{position:'absolute',top:40, right:ui.padding,opacity:opacityMenu}} animatedColor={animatedColor}/> 
